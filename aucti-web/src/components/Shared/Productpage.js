		...
		<div className="m-3 w-4/5 h-7/10  rounded-2xl border hover:shadow-lg">
			<div className="flex justify-center">
				...
				<div className="m-2 flex flex-col w-4/6  font-sofia">
					...
					<div className="ml-1 py-1 text-5xl font-bold">₹15000</div>
					<div className="ml-1  text-2xl font-semibold text-purple-700">
						Base Price
					</div>

					<div className="ml-1 py-1 text-5xl font-bold">₹35000</div>
					<div className="ml-1  text-2xl font-semibold text-purple-700">
						Highest Bid
					</div>
					...
					<div className="ml-1 py-2 text-xl  ">
						The shorts are such a great color and in really good condition. They
						were stiff upon arrival but softened up after the initial wash. Wish
						I had taken better measurements as they are much bigger in all areas
						except for the waist :( but that's on me. Shipping was speedy and
						item was packaged well.
					</div>
				</div>
			</div>
		</div>
