        ...
        <div className="m-2 flex flex-col w-4/6  font-sofia">
          ...
          <div className="ml-1 py-2">
            <div className="flex">
              ...
              {(!props.wishlist || !props.wishlistadded ) ? <Button onClick={(e)=>{e.preventDefault();addwishlist(props.id)}} text={"Add to Wishlist"} />:<span className="bg-gray-400 mx-2 rounded-lg  px-2 text-xl">already added to wishlist</span>}
            </div>
          </div>
          <div className=" py-2">
