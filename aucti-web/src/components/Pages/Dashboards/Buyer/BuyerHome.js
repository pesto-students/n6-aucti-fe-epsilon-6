...
const BuyerHome = (props) => {
	...
	return (
		<>
			<h1 className="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200 px-8 pb-4">
				{"Welcome, " + user?.displayName}
			</h1>

			<div className="px-4 md:px-10 mx-auto w-full pb-16">
				<div>
					...
					<div className="">
						...
						<div className="mt-1 relative rounded-md shadow-sm">
							...
							<input
								...
								name="price"
								id="price"
								className="mt-1 block w-full pl-7 pr-12 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
								placeholder="0.00"
							/>
						</div>
					</div>
